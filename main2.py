...
def new_window():
    ...
    mid(app)
    icon(app)
    btn_1 = tk.Button(app, text='Settings', width=7, height=1, relief=GROOVE).place(x=238,y=3)
    btn_2 = tk.Button(app, command=logout, text='Logout', width=7, height=1, relief=GROOVE).place(x=238,y=33)
